 ...
 */
public class IncrementalNamedTagRule implements IPredicateRule {
	 ...
	 */
	public IncrementalNamedTagRule(String startSequence, String endSequence, String partitionType, String midPartitionType) {
