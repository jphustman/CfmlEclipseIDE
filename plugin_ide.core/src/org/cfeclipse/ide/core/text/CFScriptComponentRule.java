 ...
 * @author denny
 * 
 *         this rule matches the opening for cfscript based components
 */
public class CFScriptComponentRule implements IPredicateRule {
	...
	protected boolean fBreaksOnEOF = false;
	 ...
	 */
	public CFScriptComponentRule(String startSequence, String endSequence, String partitionType, String midPartitionType) {
	...
	/**
	 * matches cfscript based components
	 * 
	 * @param scanner
	 *            the character scanner to be used
	 * @param resume
	 *            <code>true</code> if detection should be resumed, <code>false</code> otherwise
	 * @return the token resulting from this evaluation
	 * @since 2.0
	 */
