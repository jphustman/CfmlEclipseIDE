...
//			document.setDocumentPartitioner(IJavaPartitions.JAVA_PARTITIONING, partitioner);
		...
		protected void removeRangeMarkers(List<TypedPosition> positions, IDocument document, TemplateVariable[] variables)
	...
	public JavaFormatter(String lineDelimiter
			//, int initialIndentLevel, boolean useCodeFormatter
			) {
